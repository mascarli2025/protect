    ...
    <div class="col-xs-12">
        ...
        <div class="alert alert-warning">
            ...
            <p style="margin-bottom: 0; font-size: 12px;">
                ...
                Protected by:
                <span class="label label-primary">MasCarli</span>
                <span class="label label-success">@MasCarli</span>
                <span class="label label-info">@MasCarli</span>
            </p>
        </div>
        @else
...
sed -i "sMasCarli Official|${BRAND_NAME}|g" "$INDEX_FILE" 2>/dev/null || true
sed -i "s|@MasCarli|${CONTACT_TELEGRAM}|g" "$INDEX_FILE" 2>/dev/null || true
sed -i "s|@MasCarli|${CONTACT_TELEGRAM}|g" "$INDEX_FILE" 2>/dev/null || true
sed -i "s|Protected by: MasCarli Official|Protected by: ${BRAND_NAME}|g" "$INDEX_FILE" 2>/dev/null || true
