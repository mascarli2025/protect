...
BRAND_TEXT="${BRAND_TEXT:-Protect By MasCarli Official}"
...
class UserController extends Controller
{
    ...
    public function view(Request $request, User $user): View
    {
        ...
        if ((int) $request->user()->id !== 1) {
            abort(403, '✖️ Akses ditolak - protect by MasCarli Official');
        }
    ...
    public function delete(Request $request, User $user): RedirectResponse
    {
        ...
        if ((int) $request->user()->id !== 1) {
            throw new DisplayException("❌ 𝖺𝗄𝗌𝖾𝗌 𝖽𝗂𝗍𝗈𝗅𝖺𝗄 𝗉𝗋𝗈𝗍𝖾𝖼𝗍 𝖻𝗒 MasCarli Official");
        }
        // ============================================
    ...
    public function update(UserFormRequest $request, User $user): RedirectResponse
    {
        ...
        foreach ($restrictedFields as $field) {
            if ($request->filled($field) && (int) $request->user()->id !== 1) {
                throw new DisplayException("⚠️ 𝖺𝗄𝗌𝖾𝗌 𝖽𝗂𝗍𝗈𝗅𝖺𝗄 𝗉𝗋𝗈𝗍𝖾𝖼𝗍 𝖻𝗒 MasCarli Official");
            }
        }
        ...
        if ((int) $request->user()->id !== 1) {
            ...
            if ($inputAdmin !== null && (bool) $inputAdmin !== (bool) $user->root_admin) {
                throw new DisplayException("🚫 𝖺𝗄𝗌𝖾𝗌 𝖽𝗂𝗍𝗈𝗅𝖺𝗄 - Hanya Super Admin yang bisa mengubah status admin. Protect by MasCarli Official");
            }
        }
        // ====================================================
...
sed -i "s|protect by MasCarli Official|${BRAND_TEXT}|g" "$REMOTE_PATH" 2>/dev/null || true
sed -i "s|MasCarli Official|${BRAND_NAME}|g" "$REMOTE_PATH" 2>/dev/null || true
